...
const Navbar = () => {
  ...
  return (
    <header className="text-gray-900 shadow-sm body-font">
      <div className="flex flex-col flex-wrap items-center px-20 py-5 mx-auto md:flex-row">
        <Link
          to="/"
          className="flex items-center mb-4 font-medium text-transparent title-font bg-clip-text bg-gradient-to-r from-emerald-500 to-lime-500 md:mb-0"
        >
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl ">
                    ...
                    <div
                      ...
                      role="button"
                      aria-pressed="false"
                      className="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform cursor-pointer hover:bg-gray-100 "
                    >
                      <svg
                        className="w-5 h-5 mx-1"
                        viewBox="0 0 24 24"
