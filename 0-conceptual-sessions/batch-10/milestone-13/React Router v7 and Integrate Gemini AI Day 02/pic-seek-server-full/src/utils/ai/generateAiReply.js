  ...
  history: [
    {
      ...
      parts: [
        {
          text: 'Hello. I will Give you a prompt of a image and a comment by user. you have to reply to the user based on the prompt.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      parts: [
        {
          text: 'Glad you like it! Just do not forget your parachute when visiting—gravity is still a thing! ☁️🏙️',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      parts: [
        {
          text: 'Thanks! Just hope they wake up before re-entering Earths atmosphere... 🚀😴🌍',
        },
      ],
    },
  ],
...
// Generate AI reply based on prompt and comment
const generateAiReply = async (prompt, comment) => {
  const finalPrompt = `prompt: ${prompt} comment:${comment}`;
